...
class Musician:
    ...
    @name.setter
    def name(self, name):
        self.__name = name if isinstance(name, str) and len(name) > 1 else 'unknown'
    ...
    def play(self, song_title, *args, **kwargs):
        ...
        t = song_title if song_title and isinstance(song_title, str) else 'unknown song'
        g = ' '.join([a for a in args]) if args else ''
        rc = ''
        if 'rhythm_count' in kwargs:
            rc = kwargs['rhythm_count']
            del kwargs['rhythm_count']
        m = ' '.join([str(v) for v in kwargs.values()]) if kwargs else ''

        return f'{self.name} playing {t}: {rc} {g} ... {m}'
    ...
    def from_str(cls, musician_string):
        ...
        name = musician_string.split('(')[0].strip()
...
#%%
# Print objects
george = Musician(name='George Harrison', is_band_member=True)
print(george)

#%%
# Compare objects
george = Musician(name='George Harrison', is_band_member=True)
print(george == Musician(name='George Harrison', is_band_member=True))
...
# Calling methods
george = Musician(name='George Harrison', is_band_member=True)
print(george.play('Taxman', 'Thank you!', 'You\'re wonderful!', love='We love you!',
                  rhythm_count='1, 2, 3, 4!'))
...
george = Musician(name='George Harrison', is_band_member=True)
print(Musician.__mro__)

#%%
# Demonstrate @classmethod (from_str())
george = Musician(name='George Harrison', is_band_member=True)
print(george.from_str(george.__str__()))
...
class Singer(Musician):
    ...
    def what_do_you_do(self):
        ...
        print(f'I am {self.name}, a {self.vocals.name.lower().replace("_", " ")} singer.')
...
class Songwriter(Musician):
    ...
    def what_do_you_do(self):
        ...
        print(f'I am {self.name}, a songwriter and a {self.instrument.name.lower().replace("_", " ")} player.')
...
paul = Singer(name='Paul McCartney', vocals=Vocals.LEAD_VOCALS)
print(paul)
print(Singer.__mro__)
print(paul == Singer(name='Paul McCartney', vocals=Vocals.LEAD_VOCALS))
print()
paul = Songwriter(name='Paul McCartney', instrument=Instrument.BASS)
print(paul)
print(paul == Songwriter(name='Paul McCartney', instrument=Instrument.BASS))
paul.what_do_you_do()
